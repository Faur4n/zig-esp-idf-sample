...
if(WIFI_SUPPORTED)
    ...
    # wifi_nan_sync_config_t renamed/missing on IDF 5.4 — alias to wifi_nan_config_t
    string(FIND "${FILE_CONTENT}" "wifi_nan_sync_config_t" _NAN_SYNC_REF_POS)
    if(_NAN_SYNC_REF_POS GREATER -1)
        string(FIND "${FILE_CONTENT}" "pub const wifi_nan_sync_config_t" _NAN_SYNC_DEF_POS)
        if(_NAN_SYNC_DEF_POS EQUAL -1)
            string(APPEND FILE_CONTENT "\npub const wifi_nan_sync_config_t = wifi_nan_config_t;")
        endif()
    endif()
endif()
